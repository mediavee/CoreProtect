...
public class Language {
    ...
    public static void loadPhrases() {
        ...
        phrases.put(Phrase.CACHE_ERROR, "<red>WARNING: Error while validating {0} cache.");
        ...
        phrases.put(Phrase.COMMAND_NOT_FOUND, "Command <dark_aqua>\"{0}\"<white> not found.");
        ...
        phrases.put(Phrase.DATABASE_LOCKED_3, "To disable database locking, set <dark_aqua>\"database-lock: false\"<white>.");
        ...
        phrases.put(Phrase.GLOBAL_ROLLBACK, "Use <dark_aqua>\"{0}\"<white> to do a global {rollback|restore}");
        ...
        phrases.put(Phrase.HELP_INSPECT_7, "Tip: You can use just <dark_aqua>\"/co i\"<white> for quicker access.");
        ...
        phrases.put(Phrase.HELP_NO_INFO, "Information for command <dark_aqua>\"{0}\"<white> not found.");
        phrases.put(Phrase.HELP_PARAMETER, "Please see <dark_aqua>\"{0}\"<white> for detailed parameter info.");
        ...
        phrases.put(Phrase.HELP_PURGE_2, "For example, <dark_aqua>\"{0}\"<white> will delete all data older than one month, and only keep the last 30 days of data.");
        ...
        phrases.put(Phrase.INCOMPATIBLE_ACTION, "<dark_aqua>\"{0}\"<white> can't be used with that action.");
        ...
        phrases.put(Phrase.INVALID_BRANCH_2, "To continue, set project branch to <dark_aqua>\"development\"<white>.");
        ...
        phrases.put(Phrase.INVALID_INCLUDE, "<dark_aqua>\"{0}\"<white> is an invalid block/entity name.");
        ...
        phrases.put(Phrase.INVALID_USERNAME, "<dark_aqua>\"{0}\"<white> is an invalid username.");
        ...
        phrases.put(Phrase.MISSING_PARAMETERS, "Please use <dark_aqua>\"{0}\"<white>.");
        ...
        phrases.put(Phrase.PLEASE_SELECT, "Please select: <dark_aqua>\"{0}\"<white> or <dark_aqua>\"{1}\"<white>.");
        ...
        phrases.put(Phrase.PURGE_STARTED, "Data purge started on <dark_aqua>\"{0}\"<white>.");
        ...
        phrases.put(Phrase.ROLLBACK_COMPLETED, "{Rollback|Restore|Preview} completed for <dark_aqua>\"{0}\"<white>.");
        phrases.put(Phrase.ROLLBACK_EXCLUDED_USERS, "Excluded {user|users}: <dark_aqua>\"{0}\"<white>.");
        phrases.put(Phrase.ROLLBACK_INCLUDE, "{Included|Excluded} {block|entity|target} {type|types}: <dark_aqua>\"{0}\"<white>.");
        ...
        phrases.put(Phrase.ROLLBACK_SELECTION, "Radius set to <dark_aqua>\"{0}\"<white>.");
        phrases.put(Phrase.ROLLBACK_STARTED, "{Rollback|Restore|Preview} started on <dark_aqua>\"{0}\"<white>.");
        phrases.put(Phrase.ROLLBACK_TIME, "Time range: {0}.");
        phrases.put(Phrase.ROLLBACK_WORLD_ACTION, "Restricted to {world|action} <dark_aqua>\"{0}\"<white>.");
        ...
        phrases.put(Phrase.USER_NOT_FOUND, "User <dark_aqua>\"{0}\"<white> not found.");
        phrases.put(Phrase.USER_OFFLINE, "The user <dark_aqua>\"{0}\"<white> is not online.");
        ...
        phrases.put(Phrase.WORLD_NOT_FOUND, "World <dark_aqua>\"{0}\"<white> not found.");
